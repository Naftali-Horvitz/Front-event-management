    ...
    <main className="home-page w-full min-h-screen overflow-x-hidden" dir="rtl">
      ...
      <div className="w-full max-w-6xl mx-auto px-4 py-16 relative">
        ...
        <div className="hero-content text-center mb-16 animate-on-scroll">
          ...
          <button className="hero-button mt-8 bg-blue-600 text-white px-8 py-4 rounded-lg text-lg font-semibold">
            התחילו עכשיו
          </button>
        </div>
        ...
        <div className="text-center animate-on-scroll">
          ...
          <button className="hero-button bg-blue-600 text-white px-8 py-4 rounded-lg text-lg font-semibold">
            הצטרפו עכשיו
          </button>
        </div>
      </div>
